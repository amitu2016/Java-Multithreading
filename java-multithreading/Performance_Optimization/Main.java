...
public class Main {
    public static final String SOURCE_FILE = "java-multithreading\\resources\\many-flowers.jpg";
    public static final String DESTINATION_FILE = "java-multithreading\\out\\many-flowers.jpg";
